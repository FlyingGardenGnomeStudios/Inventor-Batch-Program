...
Public Class Overwrite
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        For Each Row In dgvOverwrite.Rows
            ...
            If dgvOverwrite(dgvOverwrite.Columns("chkOverwrite").Index, Row.index).Value = False Then
                For X = 0 To Main.dgvSubFiles.RowCount - 1
                    If dgvOverwrite(dgvOverwrite.Columns("DrawingName").Index, Row.index).Value =
                        Main.dgvSubFiles(Main.dgvSubFiles.Columns("DrawingName").Index, X).Value Then
                        Main.dgvSubFiles(Main.dgvSubFiles.Columns("chkSubFiles").Index, X).Value = False
                        Exit For
                    End If
                Next
            End If
